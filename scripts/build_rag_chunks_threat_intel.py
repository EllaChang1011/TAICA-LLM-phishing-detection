...
This is the "threat intelligence" RAG design — the knowledge base is general
phishing/threat-intel documentation, used as an explanatory layer in the demo
(see CoT report). For the alternative "few-shot exemplar" RAG design (retrieving
similar labeled training emails), see build_rag_chroma_examples.py.
